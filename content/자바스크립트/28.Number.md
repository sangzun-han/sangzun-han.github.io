...
- Number.MAX_ SAFE_ INTEGER : 자바스크립트에서 안전하게 표현할 수 있는 가장 큰 정수값
- Number.MIN_ SAFE_ INTEGER : 자바스크립트에서 안전하게 표현할 수 있는 가장 작은 정수값
...
- Number.prototype.toExponetial : 숫자를 지수 표기법으로 변환하여 문자열로 반환한다. ***숫자 리터럴과 함께 사용할 경우 에러가 발생한다.***
